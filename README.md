...
<img src="images/weld_gui.png" alt="drawing" width="700"/>
 ...
 Предусмотрено создание **pdf** файла фрмата А4 с результатами подбора катета. Отчет может содержать от одного до трех рассмотренных вариантов в любом сочетании. На лист отчета могут быть  добавлены рамка и форма 2 (основная надпись) по ГОСТ 2.104-2006.

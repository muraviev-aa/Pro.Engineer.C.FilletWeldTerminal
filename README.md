...
<strong> &#128194; weld_fillet_gui </strong> - настольное приложение
 ...
 Приложение разработано  с использованием **Glade ,GTK+ 3, GLib, Cairo, CSS, SQLite**. Виджеты диалогового окна снабжены всплывающими подсказками.
...
<img src="images/weld_gui.png" alt="drawing" width="700"/>
 ...
 Предусмотрено создание **pdf** файла формата А4 с результатами подбора катета. Отчет может содержать от одного до трех рассмотренных вариантов в любом сочетании. По желанию, на лист отчета могут быть  добавлены рамка и форма 2 (основная надпись) по ГОСТ 2.104-2006. 

<p align="center">
<img src="images/report.png" alt="drawing" width="690"/>
</p>

 Заполнение штампа возможно как вручную, так и из БД, при выборе соответствующей строки в таблице. Для этого предусмотерно диалоговое окно "Форма 2. Заполнение основной надписи".

<p align="center">
<img src="images/base.png" alt="drawing" width="690"/>
</p>

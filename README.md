...
<img src="images/weld_gui.png" alt="drawing" width="700"/>
 ...
 Предусмотрено создание **pdf** файла формата А4 с результатами подбора катета. Отчет может содержать от одного до трех рассмотренных вариантов в любом сочетании. По желанию, на лист отчета могут быть  добавлены рамка и форма 2 (основная надпись) по ГОСТ 2.104-2006. Заполнение штампа возможно как вручную, так и из БД при выборе соответствующей строки в таблице.
